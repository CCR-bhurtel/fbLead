...
const NINOX_HOTEL_TABLE_ID = process.env.NINOX_HOTEL_TABLE_ID;
const NINOX_HOTEL_OFFERTE_TABLE_ID = process.env.NINOX_HOTEL_OFFERTE_TABLE_ID;
...
const FACEBOOK_USER_ACCESS_TOKEN_NEW = process.env.FACEBOOK_USER_ACCESS_TOKEN_NEW;
